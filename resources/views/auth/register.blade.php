                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="name" placeholder="Full Names"value="{{ old('name') }}">
                        ...
                        <div class="form-group{{ $errors->has('phonenumber') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                name="phonenumber" placeholder="Phone Number" value="{{ old('phonenumber') }}">
