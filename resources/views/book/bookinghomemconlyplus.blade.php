...
<div class="list-group">
  ...
  <a href="mconlyplus" class="list-group-item active" style="background-color:#b300b3;">WEDDING M.C. ONLY   <i class="fa fa-plus-circle" aria-hidden="true"></i></a>
  ...
  <div class="panel-heading">WEDDING M.C. ONLY<p class="pull-right btn btn-default">KES 100,000.00</p></div>
  <div class="panel-body">
  <ul class="classlobster">
<li>Experience Conceptualization: dreaming up a unique and exclusive experience specific to your wedding </li> <br/>
...
<a href="package/mconlyplus" class="btn btn-primary pull-right"> Book Package </a>
  </div>
</div>  
</div>
</div>
